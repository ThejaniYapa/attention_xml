...
def get_mlb(classes: TClass = None, mlb: TMlb = None, targets: TTarget = None) -> MultiLabelBinarizer:
...
def get_precision(prediction: TPredict, targets: TTarget, mlb: TMlb = None, classes: TClass = None, top: int = 5) -> float:
...
def get_ndcg(prediction: TPredict, targets: TTarget, mlb: TMlb = None, classes: TClass = None, top: int = 5) -> float:
    mlb = get_mlb(classes, mlb, targets)
